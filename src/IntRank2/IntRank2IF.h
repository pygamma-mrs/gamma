...
#include <IntRank2/IntRank2ACmp.h>	// Rank 2 space tensor components
...
#include <IntRank2/CompRot.h>		// Composite rotations
#include <IntRank2/SolidSys.h>		// Solid state systems
#include <IntRank2/CartMx2A.h>		// Convert Cartesian A to GAMMA A
#include <IntRank2/FrameMap.h>		// Mapping of Reference Frames

#include <IntRank2/HDipolar.h>		// Dipolar Hamiltonians
#include <IntRank2/HQuadrup.h>		// Quadrupolar Hamiltonians
